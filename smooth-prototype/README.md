...
```bash
python3 -m http.server 4173 --directory smooth-prototype
```
...
- Local browser persistence and a reset control
- Mobile and desktop phone-frame layouts

## Type sources

- Tanker — Fontshare
- Martian Mono and Instrument Sans — Google Fonts, SIL Open Font License 1.1
