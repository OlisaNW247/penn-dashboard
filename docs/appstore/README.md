...
5. `7-settings-reminders.png` — reminders / announcement watching (the
   file really is numbered 7; `capture-screenshots.sh` has named it that
   since the shots between were dropped)
